...
function initData(data, flag) {
    ...
    for (var i = 0; i < item_c2.length; i++) {
        ...
        li = li + ' <div class="mui-input-row">';
        li = li + '  <label for="fxm">姓名</label>';
        li = li + '  <input type="text" id="fxm" name="fxm" readonly="readonly" value="' + item_c2[i].xm + '"/>';
        li = li + ' </div>';
        li = li + ' <div class="mui-input-row">';
        li = li + '    <label for="fzw">职务</label>';
        li = li + '  <input type="text" id="fzw" name="fzw" readonly="readonly" value="' + item_c2[i].zhiwu + '"/>';
        li = li + '    </div>';
        li = li + ' </div> ';
        $("#mxlist_ry").append(li);
    }
