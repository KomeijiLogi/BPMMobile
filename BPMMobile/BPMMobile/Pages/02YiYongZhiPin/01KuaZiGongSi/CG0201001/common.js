...
function tapEvent() {
    ...
    $('#tjmx_gys').on('tap', function () {
        ...
        li = li + '   <input type="text" id="famount" name="famount" placeholder="请填写金额" />';
        li = li + '   </div>';
        li = li + '   <div class="mui-input-row">';
...
function initData(data, flag) {
    ...
    for (var i = 0; i < item_c1.length; i++){
        ...
        li = li + '   <div class="mui-input-row">';
        li = li + '    <label for="famount">金额(元)</label>';
        li = li + '   <input type="text" id="famount" name="famount" readonly="readonly" value="' + item_c1[i].famount + '"/>';
        li = li + '   </div>';
        li = li + '   <div class="mui-input-row">';
        li = li + '    <label for="fremark">备注</label>';
